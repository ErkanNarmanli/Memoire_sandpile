...
\title{Jacobienne de graphes aléatoires}	%Titre
...
\newcommand{\re}{\mathfrak{Re}}  							%Partie réelle
\newcommand{\im}{\mathfrak{Im}}  							%Partie imaginaire
...
\newcommand\coord[2]{\begin{pmatrix}
		...
		#2 
	\end{pmatrix}}
	\newcommand\cooord[3]{\begin{pmatrix}
			#1 \\
			#2 \\
			#3
		\end{pmatrix}}
		\newcommand\coooord[4]{\begin{pmatrix}
				#1 \\
				#2 \\
				#3 \\
				#4
