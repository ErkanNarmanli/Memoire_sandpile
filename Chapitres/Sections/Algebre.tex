\section{Prémices d'algèbre}
	...
	Dans le reste de cette section, on fixera~$G$ \marginnote{$G$} un groupe abélien fini, et~$n$ un entier naturel non nul.
	...
	\begin{lem}[Estimation de la quantité d'homomorphismes faibles]\label{lem:3.1}
